...
start "baseapp1" "%KBE_BIN_PATH%/baseapp.exe" --cid=7001 --gus=7
start "baseapp2" "%KBE_BIN_PATH%/baseapp.exe" --cid=7002 --gus=8 --hide=0
start "cellapp" "%KBE_BIN_PATH%/cellapp.exe" --cid=8001 --gus=9
start "cellapp2" "%KBE_BIN_PATH%/cellapp.exe" --cid=8002  --gus=10 --hide=0
